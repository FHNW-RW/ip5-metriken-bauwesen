...
FIELD_FIELD_GARAGE_TYPE_UG_PRESENT: Final = "garage_ug_present"
FIELD_FIELD_GARAGE_TYPE_OG_PRESENT: Final = "garage_og_present"
FIELD_FIELD_GARAGE_COMBINED_PRESENT: Final = "FIELD_FIELD_GARAGE_COMBINED_PRESENT"
